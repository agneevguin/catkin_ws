...
"""autogenerated by genpy from am_planning/PathToPoseRequest.msg. Do not edit."""
import sys
...
class PathToPoseRequest(genpy.Message):
  _md5sum = "609c9e24822d1def519c6634dd414973"
  _type = "am_planning/PathToPoseRequest"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """geometry_msgs/PolygonStamped border
...
float64 w
"""
  __slots__ = ['border','start','goal']
  _slot_types = ['geometry_msgs/PolygonStamped','geometry_msgs/PoseStamped','geometry_msgs/PoseStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PathToPoseRequest, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.border is None:
        self.border = geometry_msgs.msg.PolygonStamped()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3I.pack(_x.border.header.seq, _x.border.header.stamp.secs, _x.border.header.stamp.nsecs))
      _x = self.border.header.frame_id
      length = len(_x)
      ...
      length = len(self.border.polygon.points)
      buff.write(_struct_I.pack(length))
      for val1 in self.border.polygon.points:
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.border.header.seq, _x.border.header.stamp.secs, _x.border.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.border.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.border.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.border.polygon.points = []
      for i in range(0, length):
        ...
        self.border.polygon.points.append(val1)
      _x = self
      start = end
      end += 12
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from am_planning/PathToPoseResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class PathToPoseResponse(genpy.Message):
  _md5sum = "58d6f138c7de7ef47c75d4b7e5df5472"
  _type = "am_planning/PathToPoseResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PathToPoseResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
class PathToPose(object):
  _type          = 'am_planning/PathToPose'
  _md5sum = '783cfa47b41dfec4009f6dfdb0946ccb'
  _request_class  = PathToPoseRequest
  _response_class = PathToPoseResponse
