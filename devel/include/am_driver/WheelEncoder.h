...
struct MD5Sum< ::am_driver::WheelEncoder_<ContainerAllocator> >
{
  ...
  {
    return "3b7626833ed0f03119060c12be642117";
  }

  static const char* value(const ::am_driver::WheelEncoder_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3b7626833ed0f031ULL;
  static const uint64_t static_value2 = 0x19060c12be642117ULL;
};
